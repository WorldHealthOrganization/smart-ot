...
* labTests 0..* BackboneElement "Details of tests performed" "Details of tests performed"
  * sampleId	0..1	string	"Sample ID 1"	"First Sample ID 1"
  * sampleType	0..1	string	"Type of specimen (blood, stool, CSF, skin smear…..) 1"	"Type of specimen (blood, stool, CSF, skin smear…..) 1"
  * collectionDate	0..1	date	"Collection date 1"	"Collection date 1"
