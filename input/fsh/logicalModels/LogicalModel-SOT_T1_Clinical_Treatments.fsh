...
* priorTreatmentInfo 0..* treatmentInfo "Describe treatment received prior to admission" "Describe treatment received prior to admission"
...
* treatmentDuringAdmissionInfo 0..* treatmentInfo "Describe Treatments received by the patient for this episode during admission" "Describe Treatments received by the patient for this episode during admission"
